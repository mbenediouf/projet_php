...
<body>
    ...
    if(isset($_POST['boutton'])){
      ...
      $nom = $_POST['produit_pris'];
      $date1 = $_POST['date_d_expiration'];
      $date2 = $_POST['date_de_fabrication'];

        if(!empty($nom) && !empty($date1) && !empty($date2)){
          
          $req = $conn->prepare("INSERT INTO produits_pris(produit_pris, date_de_fabrication, date_d_expiration) VALUES(:nom, :date1, :date2)");
       ...
       <div class="row justify-content-center">
        <div class="col-5 bg-light">
            <form action="" method="post">
                <div class="mb-3">
                  <label for="nom" class="form-label">produit_pris:</label>
                  <input type="text" class="form-control" id="nom" name="produit_pris">
                </div>
                <div class="mb-3">
